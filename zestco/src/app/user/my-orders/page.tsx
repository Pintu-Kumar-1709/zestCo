...
import { ArrowLeftCircle, PackageSearch } from "lucide-react";
...
const MyOrders = () => {
  ...
  return (
    <div className="bg-linear-to-b from-white to-gray-200 min-h-screen w-full">
        ...
        <div className="fixed top-0 left-0 w-full backdrop-blur-lg bg-white/70 shadow-sm border-b z-50">
          <div className="max-w-3xl mx-auto flex items-center gap-4 px-4 py-3">
            <button
              ...
              onClick={() => router.push("/")}
            >
              <ArrowLeftCircle size={25} className="text-amber-700" />
            </button>
